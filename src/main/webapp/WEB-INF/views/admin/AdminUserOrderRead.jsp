...
<body>
	...
	<div class="main">
		<div class="board_div">
			<h2 class="page-header">주문정보보기</h2>
					...
					<div class="header">
						...
						<div class="infos">
							...
							<div  class="infos_detail">
								<input class = "infos_input" type="text" name="member_id" id="member_id" value="${userOrderDto.member_id}" disabled="disabled"/>
							</div>									
						</div>
						...
						<div class="infos">
							...
							<div  class="infos_detail">
								<input class = "infos_input" type="text" name="order_bunho"value="${memberDto.order_bunho}" disabled="disabled"/>
							</div>
						</div>
