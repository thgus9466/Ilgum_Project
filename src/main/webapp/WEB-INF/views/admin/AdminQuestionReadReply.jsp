			...
			<h2 class="text-left">답변글 입력하기</h2><p></p>
				<div class="table table-responsive">
					<table class="table table-striped">
						...
						<tr>
							<td>작성일</td>
							<td><input type="text"  class="form-control" value="${questionDto.a_date}"readonly="readonly"></td>
						</tr>
						<tr>
							<td>제목</td>
							<td><input type="text"  class="form-control" value="${questionDto.a_title}"readonly="readonly"></td>
						</tr>
						<tr>
							<td>분류</td>
						...
						<tr>
							<td>글내용</td>
							<td><textarea rows="20" cols="50" name="content" class="form-control" readonly="readonly">${questionDto.a_content}</textarea></td>
						</tr>
						<tr>  
							<td colspan="2"  class="text-center">
								...
								<input type="button" value="답글쓰기" class="btn btn-success" onclick="upFun('${root}','${questionDto.q_number}','${pageNumber}')"/>
