				...
				<form action="${root}/admin/AdminQuestionWriteOk.do" method="post">
					<div class="table table-responsive">
						<table class="table table-striped">
							...
							<tr>   
								<td>제목</td>
								<td><input type="text"  class="form-control" name="a_title" value="${questionDto.a_title}"></td>
							</tr>
							<tr>
								<td>글내용</td>
								<td>
									<textarea rows="20" cols="50" name="a_content" class="form-control" >${questionDto.a_content}
/----------------------------------------------------------------------------------------------------/
