...
<form action="${root}/order/nonMemberPay.do" method="post">
	<input type="hidden" name="book_isbn" value="${orderDto.book_isbn}"/>
	<input type="hidden" name="cart_quantity" value="${orderDto.cart_quantity}"/>
	<input type="hidden" name="total_price" value="${orderDto.total_price}"/>
	<div class="container">
		...
		<div class="pay_content">
			...
			<div class="payment_info">
				<table>
					...
					<tr>
						<td>
						<img src="${orderDto.book_img_url}" alt="" style="width: 100px; height: 100px; float: left">
							<div class="prod_info">
