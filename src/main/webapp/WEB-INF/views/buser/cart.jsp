         ...
         <div align="center" class="blist">
            ...
            <table>
               ...
               <tr class="tcontent" id="${cartDto.book_isbn}">
                  <td align="center"width="80"><input type="checkbox" name="checkRow" id="${cartDto.book_isbn}" value="${cartDto.book_isbn}"
                  ...
                  <td align="center"width="240" style="margin-right: 20px;">${cartDto.book_name}</td>
                  <td align="center"width="130">
                     <fmt:formatNumber value="${cartDto.book_price*cartDto.cart_quantity}"/>원</td>
                  <td align="center"width="90">${cartDto.cart_quantity}</td>
               </tr>
               </c:forEach>
               </table>
               </div>
