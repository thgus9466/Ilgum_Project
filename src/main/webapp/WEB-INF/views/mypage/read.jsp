		...
		<div align="center" class="read">
			<table>
				...
				<tr>
					...
					<td align="center" height="20" width="125" >${member_name}</td>
					
					<td align="center" height="20" width="125" >작성일</td>
					<td align="center" height="20" width="125" >
						<fmt:formatDate value="${questionDto.q_date}" pattern="yyyy.MM.dd"/>				
					</td>
				</tr>
				
				<tr>
					<td align="center" height="200" width="125" >글내용</td>
					<td valign="top" height="200" colspan="3">${questionDto.q_content}</td>
				</tr>
				
				<tr>
					<td align="center" height="30" colspan="4">
						<input type="button" value="글 삭제" onclick="location.href='${root}/mypage/delete.do?pageNumber=${pageNumber}&q_number=${questionDto.q_number}'"/>
