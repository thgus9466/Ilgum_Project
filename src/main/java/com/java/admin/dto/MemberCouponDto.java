...
public class MemberCouponDto {
	...
	private String member_couponNumber;			//쿠폰번호 PK
	private String member_id;					//아이디 member table member_id FK (FK ID: member_id_fk)
	private String admin_couponNumber;			//관리자쿠폰번호  admincoupon table admin_couponNumber FK (FK ID: admin_couponNumber_fk)
