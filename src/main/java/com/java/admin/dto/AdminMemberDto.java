...
public class AdminMemberDto {
	...
	public String toString() {
		return "AdminMemberDto [member_id=" + member_id + ", member_password=" + member_password + ", member_name="
				+ member_name + ", member_gender=" + member_gender + ", member_zipcode=" + member_zipcode
				+ ", member_address1=" + member_address1 + ", member_address2=" + member_address2 + ", member_phone1="
				...
				+ ", member_level=" + member_level + ", member_point=" + member_point + "]";
	}
