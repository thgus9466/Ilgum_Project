...
public class MemberServiceImp implements MemberService {
	...
	public void memberLoginOk(ModelAndView mav) {
		...
		if (member_id != null && !member_level.equals("withdrawal")) {
			...
			IlgumAspect.logger.info(IlgumAspect.logMsg + session.getAttribute("member_id") + "member_level : "
	...
	public void memberIdSearchOk(ModelAndView mav) {
		...
		IlgumAspect.logger
				.info(IlgumAspect.logMsg + request.getParameter("member_name") + request.getParameter("member_email"));
