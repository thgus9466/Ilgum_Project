...
public class OrderDto {
   ...
   public OrderDto(int order_num, String member_id, String cart_quantity, String member_zipcode,
         String member_address1, String member_address2, String member_phone1, int member_point,
         String member_user__couponnumber, char order_state, char order_charge, String order_date, int total_price,
         String book_isbn, String book_name, String book_img_url, int book_price) {
      super();
   ...
   public String toString() {
      return "OrderDto [order_num=" + order_num + ", member_id=" + member_id + ", cart_quantity=" + cart_quantity
            ...
            + member_address2 + ", member_phone1=" + member_phone1 + ", member_point=" + member_point
            ...
            + ", book_isbn=" + book_isbn + ", book_name=" + book_name + ", book_img_url=" + book_img_url
